...
def load_IMDB_data(prefix='data.py/preprocessed/IMDB_processed'):
...
def load_DBLP_data(prefix='data.py/preprocessed/DBLP_processed'):
...
def load_glove_vectors(dim=50):
    ...
    file_paths = {
        50: 'data.py/wordvec/GloVe/glove.6B.50d.txt',
        100: 'data.py/wordvec/GloVe/glove.6B.100d.txt',
        200: 'data.py/wordvec/GloVe/glove.6B.200d.txt',
        300: 'data.py/wordvec/GloVe/glove.6B.300d.txt'
    }
